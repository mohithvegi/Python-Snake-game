...
class Snake(Frame):
    ...
    def new_game(self):
        ...
        rect1 = self.canvas.create_rectangle(WIDTH/2-rectWidth/2, HEIGHT/2-rectWidth/2, WIDTH/2+rectWidth/2\
                                             , HEIGHT/2+rectWidth/2, outline="blue", fill="blue"\
                                             , tag="rect1")
    ...
    def make_new_dot(self):
        ...
        self.dot = self.canvas.create_rectangle(dotX,dotY,dotX+self.rectWidth,dotY+self.rectWidth\
                                                ,outline="blue", fill="blue", tag="dot")
    ...
    def grow(self):
        ...
        thisRect = self.canvas.create_rectangle(x1, y1, x2, y2, outline="blue",\
                                     fill="blue", tag=thisTag)
    ...
    def end_game(self):
        ...
        if self.score > self.high_score:
            ...
            scoreFile.close()
            self.canvas.create_text(WIDTH/2,HEIGHT/2+20,text = "You beat the high score!")
Snake().mainloop()
